...
public class testClueSearch extends BaseTest {
    ...
    @Test(priority = 1,groups = {"AllClueSearch"})
    ...
    @Test(priority =10 ,groups = {"AllClueSearch"})
    ...
    @Test(priority =11,groups = {"AllClueSearch"})
    ...
    @Test(priority =12,groups = {"AllClueSearch"})
    ...
    @Test(priority =13,groups = {"AllClueSearch"})
    ...
    @Test(priority =14,groups = {"AllClueSearch"})
    ...
    @Test(priority =15,groups = {"AllClueSearch"})
    ...
    @Test(priority =16,groups = {"AllClueSearch"})
