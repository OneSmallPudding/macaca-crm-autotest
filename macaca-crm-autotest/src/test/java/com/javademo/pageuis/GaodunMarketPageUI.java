...
public class GaodunMarketPageUI {
    ...
    public static final String MMS_CONFIRM="(.//*[normalize-space(text()) and normalize-space(.)='取 消'])[1]/following::span[1]";//确定
    public static final String MMS_SAVE="(.//*[normalize-space(text()) and normalize-space(.)='温馨提示:'])[1]/following::span[1]";//保存
   ...
   //2新建短信模板
    ...
    public static final String MESSAGE_DOWN ="(.//*[normalize-space(text()) and normalize-space(.)='• 模板内容如侵犯到第三方权益须获得第三方的授权,并将授权委托凭证进行上传；下载授权委托书模板'])[1]/following::span[1]";//
    public static final String MESSAGE_SAVE ="(.//*[normalize-space(text()) and normalize-space(.)='申请说明'])[1]/following::span[1]";//保存
   ...
   //3新建市场营销活动
    ...
    public static final String PROJECT ="(.//*[normalize-space(text()) and normalize-space(.)='所属项目'])[1]/following::div[3]";//所属项目
    ...
    public static final String BUGET ="(.//*[normalize-space(text()) and normalize-space(.)='预算金额'])[1]/following::input[1]";//预算金额
